...
val oscar =
    PostAuthor("Oscar Gonzalez")

val oscarPublicacion = Publication("Feed Oscar","")
...
val paragraphsPost7 = listOf(
    Paragraph(
        ParagraphType.Text,
        "Barry Allen es un científico forense que adquiere supervelocidad tras un accidente en su " +
                "laboratorio, cuando un rayo lo alcanza y lo baña con productos químicos. Adopta el nombre " +
                "de The Flash, convirtiéndose en el hombre más rápido del mundo. Usa su velocidad para luchar " +
                "contra el crimen y proteger Central City. Es miembro fundador de la Liga de la Justicia y es conocido " +
                "por su nobleza, inteligencia y su capacidad para viajar en el tiempo y alterar realidades gracias " +
                "a la Fuerza de la Velocidad, una energía cósmica que alimenta sus poderes."
    ),
    Paragraph(
        ParagraphType.Header,
        "Cómics (DC Comics)"
    ...
    Paragraph(
        ParagraphType.Text,
        "Barry Allen debutó en Showcase #4 (1956), marcando el inicio de la Edad de Plata de los Cómics. " +
                "Fue el segundo Flash (el primero fue Jay Garrick en los años 40). Es conocido por su rol en " +
                "eventos clave del universo DC, especialmente en:"
    ),
    Paragraph(
        ParagraphType.Bullet,
        "Crisis en Tierras Infinitas (1985), donde muere heroicamente salvando el multiverso.",
        listOf(
            Markup(MarkupType.Bold, 0, 34)
        )
    ),
    Paragraph(
        ParagraphType.Bullet,
        "Flashpoint (2011), una saga donde viaja al pasado para salvar a su madre, creando una realidad alterna que reinicia el universo DC.",
        listOf(
            Markup(MarkupType.Bold, 0, 17)
        )
    ),
    Paragraph(
        ParagraphType.Header,
    ...
    Paragraph(
        ParagraphType.Bullet,
        "The Flash (2014–2023, The CW): Interpretado por Grant Gustin, la serie sigue a Barry desde el accidente que le da sus poderes hasta " +
                "enfrentar enemigos como el Reverse-Flash, Zoom, Savitar y The Thinker. Explora mucho la Fuerza de la Velocidad, líneas temporales y multiversos.",
        listOf(
            Markup(MarkupType.Bold, 0, 31)
        )
    ),
    Paragraph(
        ParagraphType.Bullet,
        "También aparece en el Arrowverse, compartiendo universo con Arrow, Supergirl y Legends of Tomorrow.",
        listOf(
            Markup(MarkupType.Bold, 22, 32)
        )
    ),
    Paragraph(
        ParagraphType.Header,
    ...
    Paragraph(
        ParagraphType.Bullet,
        "DCEU (DC Extended Universe): Interpretado por Ezra Miller, Barry aparece en:",
        listOf(
            Markup(MarkupType.Bold, 0, 29)
        )
    ),
    Paragraph(
        ParagraphType.Bullet,
        "Batman v Superman: Dawn of Justice (cameo)\n",
        listOf(
            Markup(MarkupType.Italic, 0, 29)
        )
    ),
    Paragraph(
        ParagraphType.Bullet,
        "Justice League (2017 y 2021)\n",
        listOf(
            Markup(MarkupType.Italic, 0, 29)
        )
    ),
    Paragraph(
        ParagraphType.Bullet,
        "The Flash (2023), basada en Flashpoint, donde Barry viaja al pasado, cambia la historia y desencadena el multiverso.",
        listOf(
            Markup(MarkupType.Italic, 0, 10)
        )
    ),
    Paragraph(
        ParagraphType.Text,
        ...
        listOf(
            Markup(
                ...
                0,
                9,
                "https://es.wikipedia.org/wiki/Flash_(historieta)"
            )
        )
    )
)
...
val posts: PostsFeed =
    PostsFeed(
        highlightedPost = post7,
        recommendedPosts = listOf(post7,post1, post2, post3),
        popularPosts = listOf(
            post5,
            post1.copy(id = "post6"),
            post2.copy(id = "post7")
